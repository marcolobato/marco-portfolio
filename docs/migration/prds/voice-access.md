...
| 7 | Solutions (intro + 4 sub-features + outro) | Plain markdown sections | `va-solution-basic-commands.png`, `va-solution-contextual-help.png`, `va-solution-timely-learning.png`, `va-solution-preventing-errors.png` | ✅ Done |
